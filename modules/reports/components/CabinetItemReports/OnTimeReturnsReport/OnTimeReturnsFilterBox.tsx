...
import { OnTimeReturnsFilters } from "../../../../reports/types/dto";
...
export interface Props {
    ...
    onSearch: (filters: OnTimeReturnsFilters) => void;
}

export interface State {
    filters: OnTimeReturnsFilters;
    showCustomPeriod: boolean;
    periodSelection: string;
}

export class OnTimeReturnsFilterBox extends React.Component<Props, State>{
...
// WEBPACK FOOTER //
// ./src/modules/reports/components/CabinetItemReports/OnTimeReturnsReport/OnTimeReturnsFilterBox.tsx