...
export class CabinetConfigsTab extends React.Component<DetailFormProps, State> {
    ...
    render() {
        ...
        return (
            <>
                <Row className="mb-3">
                    <Col>
                        <small className="text-muted">{localise("TEXT_CABINET_CONFIGURATION_DESCRIPTION")}</small>
                    </Col>
                </Row>
                <ConfigurationGrid site={cabinet.site} configurations={JSON.parse(cabinet.configurations)} onChange={this.onConfigsChange}
                    lookupkey="LIST_CABINET_CONFIGURATION_KEYS" excludedLookupKey="LIST_EXCLUDED_CABINET_CONFIGURATIONS_KEYS" isPermittedToEdit ={isPermittedToEdit}/>
                {
                    hasAdminPermissions &&
                    <>
                        ...
                        {
                            showAdminConfigs &&
                            <ConfigurationGrid site={cabinet.site} configurations={JSON.parse(cabinet.configurations)}
...
// WEBPACK FOOTER //
// ./src/modules/cabinet/components/CabinetDetails/Tabs/CabinetConfigsTab.tsx